...
$sql4 = mysql_query("SELECT * FROM articles WHERE id ='117'");
...
<div id="content_holder_contents">
                ...
                <!--SAMPLE DIV-->
                	<div id="s_sample2">
                    	<!--Article title-->
                    	<div style="width:525px; height:40px; float:left; margin-right:10px;"><a href="http://zodml.org/Nigeria/nigeria_photos.php"> Photography </a> > <?php echo $row4['title']; ?></div> 

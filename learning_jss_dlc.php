                        ...
                        <div id="learning_content_holder">
                       	  <div id="oma_learning_activities_box">
                               ...
                               <a href="learning_jss_coolsites.php"> <div id="oma_learning_content_box3"><div style="padding:15px; font-weight:800; font-size:20px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;"></div></div></a>
                                <a href="learning_jss_dlc.php"><div id="oma_learning_content_box8"><div style="padding:15px; font-weight:800; font-size:20px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;"></div></div></a>
                                </div>
                            </div>
                        	
    						<!--<p>&nbsp;</p>-->
                            <div id="oma_learning_content_info"></div>                         	

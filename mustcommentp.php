...
VALUES ('$bookid','$name','$email','$comment','$parentreplycode','','$datecommment')";
		...
		$sqlcontrol="select title from mustread where id = '$bookid'";
...
"\r\n" .
'BOOK URL: http://www.zodml.org/must-read.php?id='.$bookid."\r\n" .
"\r\n" .
'EMAIL: '.$email."\r\n" .
"\r\n" .
'BOOK TITLE: '.$title."\r\n" .
...
mail($email, $respond_subject,$respond_message, $headerd); 
		...
		header("Refresh: 1; URL=mustcomment.php?msg=THANK YOU");

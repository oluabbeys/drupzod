<?php  header( 'Location: http://zodml.org/about-us/our-story' ) ;  ?>
<?php 
								ini_set("display_errors", "off");
								include_once("Nigeria/scripts/config.php");
								$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=8");
...
<div id="content_holder">
                        ...
                        <a href="http://www.zodml.org/our-story.php">Our Story</a> > What We Do
                        </div>

<?php  header( 'Location: http://zodml.org/eresources/research-guide' ) ;  ?>
<?php
ini_set("display_errors", "off");
include_once("Nigeria/scripts/config.php");
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=68");
...
<title>ZODML | Research Guide</title>
<link href="css/styles.css" type="text/css" rel="stylesheet" media="screen" />
<link href="css/menu.css" type="text/css" rel="stylesheet" media="screen" />
<link href="css/bottom.css" type="text/css" rel="stylesheet" media="screen"/>
<link href="css/rguide_styles.css" type="text/css" rel="stylesheet" media="screen"/>
...
<!--CONTENT BEGINS-->
    ...
    <div id="aboutus_content_layer1"><!--Learning >--> Research Guide <a href="#" name="top"></a></div>

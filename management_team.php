<?php  header( 'Location: http://zodml.org/about-us/our-team' ) ;  ?>
<?php 
								ini_set("display_errors", "off");
								include_once("Nigeria/scripts/config.php");
								$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=14");
...
<title>ZODML | Management Team</title>
...
<div id="content_holder">
                        ...
                        <a href="http://www.zodml.org/our-team.php">Our Team</a> > Management Team
                        </div>

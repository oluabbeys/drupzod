...
<div id="content_holder">
                        ...
                        <div id="learning_content_holder">
                       	  <div id="oma_learning_activities_box">
                                <a href="learning_sss_books.php"><div id="oma_learning_content_box5"><div style="padding:15px; font-weight:800; font-size:20px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;"></div></div></a>
                               ...
                               <a href="learning_sss_dlc.php"> <div id="oma_learning_content_box4"><div style="padding:15px; font-weight:800; font-size:20px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;"></div></div></a>
                          </div>
    </div>
  ...
  <div id="oma_learning_content_info">
                                ...
                                <!-- Begin subject links-->
                               	  <div style="width:inherit; height:150px; margin-bottom:30px;">
                                		<a href="learning_sss_books_maths.php"><div id="oma_subject_picture"><br /><img src="images/Maths.png" width="150" height="113" /><br /><font size="+1"><font face="Tahoma, Geneva, sans-serif">Maths</font></font></div></a>
                                        <a href="learning_sss_books_english.php"><div id="oma_subject_picture"><br /><img src="images/english.jpg" width="150" height="113" /><br /><font size="+1"><font face="Tahoma, Geneva, sans-serif">English </font></font></div></a>
                                   </div>
                                   <div style="width:inherit; height:150px;">
                                		<a href="learning_sss_books_sciences.php"><div id="oma_subject_picture"><br /><img src="images/science.png" width="150" height="113" /><br />
                                		<font size="+1"><font face="Tahoma, Geneva, sans-serif">Science</font></font></div></a>

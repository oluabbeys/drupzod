...
$mesa=$_GET['msg'];
$firstreplyid=$_GET['firstreplyid'];
...
<table height="357" border="0" bordercolor="#000000">
  <tr bordercolor="#000000" >
    <td width="400"><form id="form1" name="form1" method="post" action="eachbookcommentp-reply.php">
      <table width="350" border="0">
        <tr align="center">
          ...
          <td width="310"><label>
            ...
            <input type="hidden" name="firstreplyid" value="<?php echo $firstreplyid; ?>">
          </label></td>
        </tr>

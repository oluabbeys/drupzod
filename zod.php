<?php  header( 'Location: http://zodml.org/about-us/zaccheus-onumba-dibiaezue' ) ;  ?>
<?php 
								ini_set("display_errors", "off");
								include_once("Nigeria/scripts/config.php");
								$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=83");
...
<title>ZODML | ZACCHEUS ONUMBA DIBIAEZUE Bio </title>
...
<!--End of leave a commemt form pop up-->
<!--Search for books-->
<script type="text/javascript">
$(function(){
...
<div id="content_holder">
                        ...
                        <a href="http://www.zodml.org/our-story.php">Our Story</a> > About Zaccheus Onumba Dibiaezue
                        </div>
                        ...
                        <td valign="top">
                                ...
                                <!--Other pictures-->
                                <!--Header-->
		<div id="oma_otherpics_holder">&nbsp;&nbsp;More Pictures of Zaccheus Onumba Dibiaezue</div>
        <!--Body-->
        <div class="gallerycontainer">


<a class="thumbnail" href="#thumb"><img src="images/ZOD pictures/conference.png" width="100px" height="66px" border="0" /><span><img src="images/ZOD pictures/conference-big.png" /><br />With Ukpabi Asika (The Administrator of the 'then' East Central State)</span></a>
<a class="thumbnail" href="#thumb"><img src="images/ZOD pictures/zodazik.png" width="100px" height="66px" border="0" /><span><img src="images/ZOD pictures/zodazik-big.png" /><br />With Chief Obafemi Awolowo (The 'then' Federal Minister of Finance)</span></a>
<br />
<a class="thumbnail" href="#thumb"><img src="images/ZOD pictures/zodazik2.png"width="100px" height="66px" border="0"/><span><img src="images/ZOD pictures/zodazik-big2.png" /><br />With Chief Obafemi Awolowo (The 'then' Federal Minister of Finance)</span></a>




<a class="thumbnail" href="#thumb"><img src="images/ZOD pictures/lawyer.png"width="100px" height="66px" border="0"/><span><img src="images/ZOD pictures/lawyer.png" /><br />As a Barrister</span></a>


<br />

<a class="thumbnail" href="#thumb"><img src="images/ZOD pictures/soldier.png"width="100px" height="66px" border="0"/><span><img src="images/ZOD pictures/soldier.png" /><br />As a Colonial Police Officer</span></a>
...
<form id="contactForm" action="processForm.php" method="post">
  ...
  <ul>
    ...
    <li>
      <label for="message" style="padding-top: .5em;" class="label">Your Question(s)</label>
      <textarea name="message" id="message" placeholder="Please type your question(s)" required cols="80" rows="10" maxlength="10000" class="textarea"></textarea>
    </li>
  <li> <center>
   <?php
...
<div id="successMessage" class="statusMessage"><p>We will endeavor to send a reply within 48 hours of receiving your question.</p></div>

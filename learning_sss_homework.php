...
<div id="content_holder">
                        ...
                        <div id="learning_content_holder2">
                       	  <div id="oma_learning_activities_box">
                               <a href="learning_sss_books.php"> <div id="oma_learning_content_box1"></div></a>
                                <a href="learning_sss_homework.php"><div id="oma_learning_content_box6"></div></a>
                                <a href="learning_sss_coolsites.php"><div id="oma_learning_content_box3"></div></a>
                                <a href="learning_sss_dlc.php"><div id="oma_learning_content_box4"></div></a>
                          </div>
    				</div>

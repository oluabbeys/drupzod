...
$msgOrderID = $_GET['OrderID'];
$msgTransactionReference = $_GET['TransactionReference'];
?>
...
<div id="content_holder">
                        ...
                        <a href="#">Support ZODML</a> > Cancelled</div>
...
<div id="zodml_cathy_text">
 ...
 <p> 
 <h1>
 <img  src="http://zodml.org/images/failure.png" align="center" style="border-width:0px; box-shadow: 0px 0px 0px;" />
                        <span style="color:red;"><strong>Your Donation Failed, <br />Reason: Customer Cancelled the Process</strong></span></h1></p>
 <p> <ul  style="color: red;">
 <li>Your <strong>Transaction Reference </strong> is <strong><?php echo "$msgTransactionReference" ?></strong> </li>

<li>Your <strong>Transaction ID </strong> is <strong><?php echo "$msgOrderID" ?></strong> </li>
<li>A copy of the receipt for this Transaction has been sent to your email </li>
</ul></p>
<p>


For Enquiries Please <a href="#contactForm">Contact Us</a> <br />
All enquries made will be responded to not later than 48 hours from the time of receipt
</p>
 </td></tr></table>

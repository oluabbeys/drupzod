<?php  header( 'Location: http://zodml.org' ) ;  ?>

<?php 
								ini_set("display_errors", "off");
								include_once("Nigeria/scripts/config.php");
								$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=3");
...
<title>ZODML | Mobile Library</title>
...
<div id="content_holder">
                        ...
                        <div id="aboutus_content_layer1">
                         <a href="http://www.zodml.org/project.php">Projects</a> > Mobile Library
                        </div>

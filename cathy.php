<?php  header( 'Location: http://zodml.org/projects/catch-them-young-cathy' ) ;  ?>
<?php 
								...
								$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=2");
...
<title>ZODML | Catch Them Young (CATHY)</title>
...
<div class="addthis_toolbox addthis_floating_style addthis_32x32_style" style="right:50px;top:25px;">
<a class="addthis_button_tweet" tw:via="zodml"></a>
...
<div id="content_holder">
                        ...
                        <a href="http://www.zodml.org/project.php">Projects</a> > CATHY
                        </div>

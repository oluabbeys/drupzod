<?php  header( 'Location: http://www.zodml.org/community-library/using-library' ) ;  ?>
<?php 
								ini_set("display_errors", "off");
								include_once("Nigeria/scripts/config.php");
								$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=38");
...
<script type="text/javascript" src="js/contact-ask.js"></script>
...
<div id="content_holder">
                        ...
                        <a href="http://www.zodml.org/our-services.php">Our Services</a> > Get Help</a>
                        </div>
...
<form id="contactForm" action="processFormAsk.php" method="post">

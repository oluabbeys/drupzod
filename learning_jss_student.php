...
<div id="content_holder">
                        ...
                        <!--CONTENT LAYER 2-->
                        <div id="learning_content_intro">
                                	<table cellspacing="40">
                                    	<tr>
                                        <td><img src="images/cutegirl.jpg" width="250" height="167" /></td>
                                        <td id="learning_text">Hello and welcome to the ‘Learning’ resource section. Here there are resources needed in several subjects to help you with
self-learning.</td>
                                        </tr>
                                      </table>
                                </div>
                        <div id="learning_content_holder">
                            ...
                            <div id="oma_learning_activities_box_title"><!--<div id="oma_learning_activities_title"></div>--></div>
                                <a href="learning_jss_books.php"><div id="oma_learning_content_box1"><div style="padding:15px; font-weight:800; font-size:20px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;"></div></div></a>
    						...
    						<!--<p>&nbsp;</p>-->
                            <div id="oma_learning_content_info">
                            
                            	
                                <div id="learning_content_body">
                                	
                                	<div id="learning_body_boxes">
                                    <div id="learning_body_boxes_title"><br />
                                    
                                    
                                     <!-- What can you find in this section pane/* --> 
                                      <strong>What can you find in this section</strong></div>
                                    <table>
                                    <tr>
                                    <td height="291" cellspacing= "40"><ul>
                                      <li><strong>e-books in various subjects</strong></li>  
                                      <strong><br />
                                      </strong>
                                      <li><strong> Links to helpful sites </strong></li>  
                                      <strong><br />
                                      </strong>
                                      <li><strong>Free access to e-books in various subjects                                      </strong></li>  
                                      <strong><br />
                                      </strong>
                                      <li><strong>Communities to interact with peers in other schools </strong></li>  
                                      <br />
                                    </ul>
                                      </p></tr>
                                    </table>
                                    ...
                                    <!-- How this section works pane/* --> 
                                  <div id="learning_body_boxes">
                                    <div id="learning_body_boxes_title"><br />
                                    <strong>How this section works</strong></div>
                                      <table>
                                    <tr>
                                    <td height="291" cellspacing= "40"><ul>
                                      <li><strong>All resources in this section are absolutely free
                                      </strong></li>
                                      <strong><br />
                                      </strong>
                                      <li><strong>You can finally find material customized to suit your learning 					                                      needs</strong></li>  
                                      <strong><br />
                                      </strong>
                                      <li><strong>Access resources to help you with your homework and learning                                      </strong></li>  
                                      <strong><br />
                                      </strong>
                                      <li><strong>You can use these resources anytime, anywhere and at your own                                       pace. </strong></li>  
                                      <br />
                                    </ul>
                                      </p></tr>
                                    </table>

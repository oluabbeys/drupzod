...
<div id="content_holder">
                        ...
                        <div id="learning_content_holder">
                       	  <div id="oma_learning_activities_box">
                               ...
                               <a href="learning_sss_coolsites.php"> <div id="oma_learning_content_box7"><div style="padding:15px; font-weight:800; font-size:20px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;"></div></div></a>

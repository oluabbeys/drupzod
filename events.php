...
$sql = "SELECT * FROM recentevents ORDER BY id DESC";
$rsd = mysql_query($sql);
...
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=75");
...
<title>ZODML | Recent events</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#eventslisting").load("events-data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#eventslisting").load("events-data.php?page=" + pageNum, Hide_Load());
	});
...
<div id="content_holder">
                        ...
                        <a href="http://www.zodml.org/explore-at-zodml.php">Explore at ZODML</a> > Recent Events</font>
                        </div>
                        ...
                        <tr><td valign="top">
                        			<div style="width:700px;">
                                      ...
                                      <!--PAGINATION-->
                                    <div style="width:600px; padding:1px; margin:15px 0px 0px 0px;">

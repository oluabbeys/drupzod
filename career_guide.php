<?php  header( 'Location: http://zodml.org/eresources/career-guide' ) ;  ?>
<?php
ini_set("display_errors", "off");
include_once("Nigeria/scripts/config.php");
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=69");
...
<title>ZODML | Career Guide</title>
<title>Zaccheus Onumba Dibiaezue Memorial Libraries|e-library in Nigeria|Library services|Career Guide</title>

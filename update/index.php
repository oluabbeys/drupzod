<?php  header( 'Location: http://zodml.org/update.php' ) ;  ?>
...
<p><h2 class="form-signin-heading" style="text-align:center;">Login Panel for Website Edits</h2></p>
<br />

<div class="container">

      <form class="form-signin" action="login_proc.php" method="post">

...
{
header("Location: other.php?user=".$_SESSION['hash']);
...
$sql = "SELECT * FROM articles WHERE category='Others' ORDER BY title ASC";
$rsd = mysql_query($sql);
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#zip").load("other-data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#zip").load("other-data.php?page=" + pageNum, Hide_Load());
	});

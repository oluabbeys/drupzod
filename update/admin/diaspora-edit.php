...
if ($_POST['parse_var'] == "new"){
	...
	if($update){
	$msg = "Discover Nigeria Article, <font color=\"#FF0000\">".stripslashes($title)."</font> Content has been edited. <a href=\"diaspora.php\"><button class=\"btn btn-large btn-primary\" type=\"submit\" id=\"update\">Edit other Diaspora Articles</button></a>";
	}
	else{
...
<title>Edit Content Page - The Diaspora Cateory</title>
      ...
      <div class="row-fluid">
		...
		?>
          ...
          <h3>Contents for <?php echo $title2; ?></h3>
            ...
            <form class="form-signin" method="post" id="formail" action="diaspora-edit.php?code=<?php echo $hashcode; ?>&user=<?php echo $user; ?>">

...
{
header("Location: short-story.php?user=".$_SESSION['hash']);
...
$sql = "SELECT * FROM shortstory ORDER BY id ASC";
$rsd = mysql_query($sql);
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#zip").load("story-data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#zip").load("story-data.php?page=" + pageNum, Hide_Load());
	});
        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
              ...
              <li  class="active"><a href="short-story.php?user=<?php echo $profile; ?>">Short Story</a></li>

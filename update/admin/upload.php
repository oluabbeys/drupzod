...
{
header("Location: upload.php?user=".$_SESSION['hash']);
        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
              ...
              <li class="active"><a href="upload.php?user=<?php echo $profile; ?>">Upload Image</a></li>
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="hero-unit">
            <h2>Upload Image</h2>
            <p style="font-family:Verdana, Geneva, sans-serif;">The image file(s) uploaded here goes directly to the <b>images</b> directory on the server and can be called up directly on a web page with the HTML tag (http://zodml.org/images/image-file-name).</p>
            <br />
          
           <form class="form-signin" action="upload2.php" method="post" enctype="multipart/form-data">
        <input type="file" name="uplo" class="input-block-level" />
        <br />
        <button class="btn btn-large btn-primary" type="submit">Upload</button>
      </form>
           <p>&nbsp;</p>
           <p><font color="#FF0000">*** Only .png, .jpg, .gif files should be uploaded ***</font></p>

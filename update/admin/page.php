...
{
header("Location: page.php?user=".$_SESSION['hash']);
...
$sql = "SELECT * FROM contentsupdate WHERE contents='Content' ORDER BY title ASC";
$rsd = mysql_query($sql);
...
<title>Geography Article Pages</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#zip").load("page-data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#zip").load("page-data.php?page=" + pageNum, Hide_Load());
	});

...
{
header("Location: edit-events.php?user=".$_SESSION['hash']);
...
<title>Recent Events Articles</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#zip").load("events-data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#zip").load("events-data.php?page=" + pageNum, Hide_Load());
	});
        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
              ...
              <li class="active"><a href="edit-events.php?user=<?php echo $profile; ?>">Edit Events</a></li>

...
if (!isset($_COOKIE['websiteedithashcookie']))
{
header("Location: ../index.php");
} 

if ($_COOKIE['websiteedithashcookie'] != $_GET['user'])
{
header("Location: geography.php?user=".$_COOKIE['websiteedithashcookie']);
...
$sql = "SELECT * FROM articles WHERE category='Geography' ORDER BY title ASC";
$rsd = mysql_query($sql);
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#zip").load("geography-data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#zip").load("geography-data.php?page=" + pageNum, Hide_Load());
	});

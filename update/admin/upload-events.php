...
{
header("Location: upload-events.php?user=".$_SESSION['hash']);
...
//The next 3 lines gather the information entered into form and turns them into php variables so they can be entered into the database
	   ...
	   $status = 'recent';
	   $hashcode = str_shuffle("recent123456");
	   
//This bit places the php variables into the correct columns in your database
//Now() generates the current date
        $sqlcreate = mysql_query("INSERT INTO recentevents (topic, story, status, hash)
		VALUES('$topic','$story', '$status', '$hashcode')");
//produces a message to let you know if the data has been successfully submited or not.
        if ($sqlcreate){
            $msg = '<font color="#009900">Recent Event article has been uploaded!</font>';
        } else {
...
<title>Upload Recent Events</title>
        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
              ...
              <li class="active"><a href="upload-events.php?user=<?php echo $profile; ?>">Events</a></li>
    ...
    <div class="container-fluid">
      <div class="row-fluid">
        <!--/span-->
          ...
          <div class="hero-unit">
            <h2>Upload Recent Event</h2>
            
            <br />
          <p><?php echo $msg; ?></p>
           <form class="form-signin" action="upload-events.php?user=<?php echo $profile; ?>" method="post" name="new">

...
{
header("Location: edit-newsletter.php?user=".$_SESSION['hash']);
...
$sql = "SELECT * FROM newsletterstories ORDER BY id DESC";
$rsd = mysql_query($sql);
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#zip").load("newsletter-data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#zip").load("newsletter-data.php?page=" + pageNum, Hide_Load());
	});
        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
              ...
              <li class="active"><a href="edit-newsletter.php?user=<?php echo $profile; ?>">Edit Newsletter Articles</a></li>

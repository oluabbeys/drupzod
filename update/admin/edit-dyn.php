...
{
header("Location: edit-dyn.php?user=".$_SESSION['hash']);
...
<title>Did You Know Articles</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#zip").load("dyn-data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#zip").load("dyn-data.php?page=" + pageNum, Hide_Load());
	});
        ...
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
              ...
              <li class="active"><a href="edit-dyn.php?user=<?php echo $profile; ?>">Edit Did You Know</a></li>

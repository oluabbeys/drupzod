...
{
header("Location: diaspora.php?user=".$_SESSION['hash']);
...
$sql = "SELECT * FROM articles WHERE category='The Diaspora' ORDER BY title ASC";
$rsd = mysql_query($sql);
...
<title>The Diaspora Article</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#zip").load("diaspora-data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#zip").load("diaspora-data.php?page=" + pageNum, Hide_Load());
	});

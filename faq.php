<?php  header( 'Location: http://www.zodml.org/faq-page' ) ;  ?>
<?php 
								ini_set("display_errors", "off");
								include_once("Nigeria/scripts/config.php");
								$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=82");
...
<title>ZODML | FAQ (Frequently Asked Questions)</title>
...
<div id="content_holder">
                        ...
                        <a href="http://www.zodml.org/our-services.php">Our Services</a> > Frequently Asked Questions</div>
                        ...
                        <tr><td>
                           ...
                           <td valign="top">         
                                    <div id="aboutus_others_cathy_hold_latest">

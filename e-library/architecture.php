...
$sql = "SELECT * FROM ebooks WHERE category='Architecture' ORDER BY title ASC";
$rsd = mysql_query($sql);
...
{
header("Location: architecture.php?ebook=".$_COOKIE['ebookhashcookie']);
...
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=40");
...
<title>ZODML | e-Library | Free e-Books | Architecture category</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#elibrary_content_books_architecture").load("architecture_data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#elibrary_content_books_architecture").load("architecture_data.php?page=" + pageNum, Hide_Load());
	});
...
<div id="content_holder">
                        ...
                        <td valign="top">
                         ...
                         <td valign="top">
                                ...
                                <h3>&nbsp;&nbsp;Free Architecture e-Books</h3>
                         		<br />
                        		<div id="elibrary_content_books_architecture">

<?php  header( 'Location: http://www.zodml.org/elibrary/marketing' ) ;  ?>
<?php
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#elibrary_content_books_marketing").load("marketing_data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#elibrary_content_books_marketing").load("marketing_data.php?page=" + pageNum, Hide_Load());
	});
                        ...
                        <td valign="top">
                            ...
                            <td valign="top">
                        		<!--Content slider on the right-->
                                 <h3>&nbsp;&nbsp;Free Marketing e-Books</h3>
                        		<div id="elibrary_content_books_marketing">

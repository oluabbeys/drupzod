<?php  header( 'Location: http://www.zodml.org/elibrary/medicine' ) ;  ?>
<?php
include("../Nigeria/scripts/config2.php");
$per_page = 10; 

//getting number of rows and calculating no of pages
$sql = "SELECT * FROM ebooks WHERE category='Medicine' ORDER BY title ASC";
$rsd = mysql_query($sql);
...
{
header("Location: medicine.php?ebook=".$_COOKIE['ebookhashcookie']);
...
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=53");
...
<title>ZODML | e-Library | Free e-Books | Medicine category</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#elibrary_content_books_medicine").load("medicine_data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#elibrary_content_books_medicine").load("medicine_data.php?page=" + pageNum, Hide_Load());
	});
...
<div id="content_holder">
                        ...
                        <td valign="top">
                            ...
                            <td valign="top">
                        		...
                        		<div id="elibrary_content_books_medicine">
                                	
                                    <h3>&nbsp;&nbsp;Free Medicine e-Books</h3>

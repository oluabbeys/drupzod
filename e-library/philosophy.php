<?php  header( 'Location: http://www.zodml.org/elibrary/philosophy' ) ;  ?>
<?php
include("../Nigeria/scripts/config2.php");
$per_page = 10; 

//getting number of rows and calculating no of pages
$sql = "SELECT * FROM ebooks WHERE category='Philosophy' ORDER BY title ASC";
$rsd = mysql_query($sql);
...
{
header("Location: philosophy.php?ebook=".$_COOKIE['ebookhashcookie']);
...
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=54");
...
<title>ZODML | e-Library | Free e-Books | Philosophy category</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#elibrary_content_books_poetry").load("philosophy_data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#elibrary_content_books_poetry").load("philosophy_data.php?page=" + pageNum, Hide_Load());
	});
...
<div id="content_holder">
                        ...
                        <td valign="top">
                            ...
                            <td valign="top">
                                ...
                                <h3>&nbsp;&nbsp;Free Philosophy e-Books</h3>
                        		<div id="elibrary_content_books_poetry">

<?php  header( 'Location: http://zodml.org/elibrary/classics' ) ;  ?>
<?php
include("../Nigeria/scripts/config2.php");
$per_page = 10; 

//getting number of rows and calculating no of pages
$sql = "SELECT * FROM ebooks WHERE category='Classics' ORDER BY title ASC";
$rsd = mysql_query($sql);
...
{
header("Location: classics.php?ebook=".$_COOKIE['ebookhashcookie']);
...
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=43");
...
<title>ZODML | e-Library | Free e-Books | Classics and Ancient Studies category</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#elibrary_content_books_classics").load("classics_data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#elibrary_content_books_classics").load("classics_data.php?page=" + pageNum, Hide_Load());
	});
...
<div id="content_holder">
                        ...
                        <td valign="top">
                            ...
                            <td valign="top">
                                ...
                                <h3>&nbsp;&nbsp;Free Classics and Ancient Studies e-Books</h3>
                        		<div id="elibrary_content_books_classics">

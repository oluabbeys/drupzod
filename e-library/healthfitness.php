<?php  header( 'Location: http://www.zodml.org/elibrary/health-and-fitness' ) ;  ?>
<?php
include("../Nigeria/scripts/config2.php");
$per_page = 10; 

//getting number of rows and calculating no of pages
$sql = "SELECT * FROM ebooks WHERE category='Health and Fitness' ORDER BY title ASC";
$rsd = mysql_query($sql);
...
{
header("Location: healthfitness.php?ebook=".$_COOKIE['ebookhashcookie']);
...
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=49");
...
<title>ZODML | e-Library | Free e-Books | Health and Fitness category</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#elibrary_content_books_health").load("health_data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#elibrary_content_books_health").load("health_data.php?page=" + pageNum, Hide_Load());
	});
                        ...
                        <td valign="top">
                            ...
                            <td valign="top">
                        		<!--Content slider on the right-->
                                 <h3>&nbsp;&nbsp;Free Health and Fitness e-Books</h3>
                        		<div id="elibrary_content_books_health">

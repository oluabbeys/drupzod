...
$sql = mysql_query("SELECT * FROM ebooks WHERE category='Engineering and Mathematics' ORDER BY title ASC limit $start,$per_page");
//$rsd = mysql_query($sql);
?>
...
<div style="width:510px; height:190px;">
                                    			<div id="elibrary_book_display_from_database">
                                    				...
                                    				<div style="width:390px; height:160px; float:left; font-size:11px;">
                                                        ...
                                                        <a href="pdf_server.php?file=../513zodml007/<?php echo $pdf; ?>" title="Click to download" onClick="javascript: _gaq.push(['_trackPageview', '/downloads/<?php echo $q; ?>']);"><div style="height:30px; width:110px; float:left; margin:0px 10px 0px 0px; background:url(../images/download.png) left no-repeat;"></div></a>  <a href="../513zodml007/<?php echo $htm; ?>" title="Click to preview" target="_blank"><div style="height:30px; width:110px; float:left; margin:0px 10px 0px 0px; background:url(../images/preview.png) left no-repeat;"></div></a>
                                                    </div>

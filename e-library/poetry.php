<?php  header( 'Location: http://www.zodml.org/elibrary/poetry' ) ;  ?>
<?php
include("../Nigeria/scripts/config2.php");
$per_page = 10; 

//getting number of rows and calculating no of pages
$sql = "SELECT * FROM ebooks WHERE category='Poetry' ORDER BY title ASC";
$rsd = mysql_query($sql);
...
{
header("Location: poetry.php?ebook=".$_COOKIE['ebookhashcookie']);
...
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=55");
...
<title>ZODML | e-Library | Free e-Books | Poetry category</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#elibrary_content_books_poetry").load("poetry_data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#elibrary_content_books_poetry").load("poetry_data.php?page=" + pageNum, Hide_Load());
	});

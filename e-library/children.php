<?php  header( 'Location: http://zodml.org/elibrary/children' ) ;  ?>
<?php
include("../Nigeria/scripts/config2.php");
$per_page = 10; 

//getting number of rows and calculating no of pages
$sql = "SELECT * FROM ebooks WHERE category='Children' ORDER BY title ASC";
$rsd = mysql_query($sql);
...
{
header("Location: children.php?ebook=".$_COOKIE['ebookhashcookie']);
...
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=42");
...
<title>ZODML | e-Library | Free e-Books | Children category</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#elibrary_content_books_children").load("children_data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#elibrary_content_books_children").load("children_data.php?page=" + pageNum, Hide_Load());
	});
                        ...
                        <td valign="top">
                            ...
                            <td valign="top">
                        		<!--Content slider on the right-->
                                 <h3>&nbsp;&nbsp;Free Children's e-Books</h3>
                        		<div id="elibrary_content_books_children">

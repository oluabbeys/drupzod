<?php  header( 'Location: http://zodml.org/elibrary/business-and-management' ) ;  ?>
<?php
include("../Nigeria/scripts/config2.php");
$per_page = 10; 

//getting number of rows and calculating no of pages
$sql = "SELECT * FROM ebooks WHERE category='Business and Management' ORDER BY title ASC";
$rsd = mysql_query($sql);
...
{
header("Location: business.php?ebook=".$_COOKIE['ebookhashcookie']);
...
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=41");
...
<title>ZODML | e-Library | Free e-Books | Business and Management category</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#elibrary_content_books_business").load("business_data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#elibrary_content_books_business").load("business_data.php?page=" + pageNum, Hide_Load());
	});
...
<div id="content_holder">
                        ...
                        <table>
                            ...
                            <td valign="top">
                            <h3>&nbsp;&nbsp;Free Business and Management e-Books</h3>
                            <br />
                        		<!--Content slider on the right-->
                        		<div id="elibrary_content_books_business">

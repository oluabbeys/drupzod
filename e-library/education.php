<?php  header( 'Location: http://zodml.org/elibrary/education' ) ;  ?>
<?php
include("../Nigeria/scripts/config2.php");
$per_page = 10; 

//getting number of rows and calculating no of pages
$sql = "SELECT * FROM ebooks WHERE category='Education' ORDER BY title ASC";
$rsd = mysql_query($sql);
...
{
header("Location: education.php?ebook=".$_COOKIE['ebookhashcookie']);
...
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=45");
...
<title>ZODML | e-Library | Free e-Books | Education category</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#elibrary_content_books_education").load("education_data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#elibrary_content_books_education").load("education_data.php?page=" + pageNum, Hide_Load());
	});
...
<div id="content_holder">
                        ...
                        <td valign="top">
                            ...
                            <td valign="top">
                                ...
                                <h3>&nbsp;&nbsp;Free Education e-Books</h3>
                        		<div id="elibrary_content_books_education">
...
<form id="contactForm" action="../processForm.php" method="post">
  ...
  <ul>
    ...
    <li>
      <label for="message" style="padding-top: .5em;" class="label">Your Message</la
<?php  header( 'Location: http://www.zodml.org/elibrary/geography-and-travel' ) ;  ?>
<?php
...
<title>ZODML | e-Library | Free e-Books | Geography and Travel category</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#elibrary_content_books_geography").load("geography_data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#elibrary_content_books_geography").load("geography_data.php?page=" + pageNum, Hide_Load());
	});
...
<div id="content_holder">
                        ...
                        <td valign="top">
                            ...
                            <td valign="top">
                                ...
                                <h3>&nbsp;&nbsp;Free Geography and Travel e-Books</h3>
                        		<div id="elibrary_content_books_geography">

...
$sql = "SELECT * FROM ebooks WHERE category='Sociology and Anthropology' ORDER BY title ASC";
$rsd = mysql_query($sql);
...
{
header("Location: sociology.php?ebook=".$_COOKIE['ebookhashcookie']);
...
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=57");
...
<title>ZODML | e-Library | Free e-Books | Sociology category</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#elibrary_content_books_sociology").load("sociology_data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#elibrary_content_books_sociology").load("sociology_data.php?page=" + pageNum, Hide_Load());
	});
...
<div id="content_holder">
                        ...
                        <td valign="top">
                            ...
                            <td valign="top">
                                ...
                                <h3>&nbsp;&nbsp;Free Sociology e-Books</h3>
                        		<div id="elibrary_content_books_sociology">

<?php  header( 'Location: http://zodml.org/about-us/jobs-and-internships' ) ;  ?>
<?php 
								ini_set("display_errors", "off");
								include_once("Nigeria/scripts/config.php");
								$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=15");
...
<title>ZODML | Support | Internship </title>
...
<div id="content_holder">
                        ...
                        <!--Support ZODML >--> <a href="http://www.zodml.org/our-team.php">Our Team</a> > Internship Programme</div>
                                        ...
                                        <div id="oma_vol_hold">
                                          <div id="zodml_cathy_text">
                                            <?php echo $content2; ?>
                                             ...
                                             <div id="interningdiv" style=" width:600px; border-top: dashed 2px #EC9F00; cursor:pointer; padding:10px; margin:10px 0px 10px 0px; font-family:Verdana, Geneva, sans-serif;">
                                                                                          <form method="post" action="" id="formail2">
                                                <table cellspacing="15">
                                                <tr>
                                                <td>Name:</td>
                                                <td><input type="text" name="i_name2" id="i_name2" placeholder="Name" /></td>
                                                </tr>
                                                <tr>
                                                <td>Email Address:</td>
                                                <td><input type="text" name="i_email2" id="i_email2" placeholder="Email"/></td>
                                                </tr>
                                                <tr>
                                                <td>Name of University/Polytechnic:</td>
                                                <td><input type="text" name="i_school2" id="i_school2" placeholder="University/Polytechnic"/></td>
                                                </tr>
                                                <tr>
                                                <td>What course are you studying and at what stage?</td>
                                                <td><input type="text" name="i_course2" id="i_course2" placeholder="Course of study"/></td>
                                                </tr>
                                                
                                                
                                                </tr>
                                                <td>Please state reasons for your interest in ZODML</td>
                                                <td><textarea name="ihelp2" id="ihelp2" placeholder="Please state reasons for your interest in ZODML" required cols="80" rows="5" maxlength="150" class="textarea"></textarea></td>
                                                </tr>
                                                <tr>
                                                <td colspan="2" align="left"><input name="" type="submit" value="Submit" id="volunteer_button2"/></td>
                                                <td></td>
                                                </tr>

<?php  header( 'Location: http://zodml.org/projects/oasis-libraries' ) ;  ?>
<?php 
								ini_set("display_errors", "off");
								include_once("Nigeria/scripts/config.php");
								$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=70");
...
<title>ZODML | Oasis Library</title>
...
<div id="content_holder">
                        ...
                        <a href="http://www.zodml.org/project.php">Projects</a>  > Oasis Libraries
                        </div>

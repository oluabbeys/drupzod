<?php  header( 'Location: http://zodml.org/projects/secondary-school-reading-programmes' ) ;  ?>
<?php 
								ini_set("display_errors", "off");
								include_once("Nigeria/scripts/config.php");
								$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=7");
...
<title>ZODML | Secondary School Reading Programmes</title>
...
<div id="content_holder">
                        ...
                        <div id="aboutus_content_layer1">
                         <a href="http://www.zodml.org/project.php">Projects</a> > Secondary School Reading Programmes
                        </div>

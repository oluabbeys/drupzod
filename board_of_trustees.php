<?php  header( 'Location: http://zodml.org/about-us/board-trustees' ) ;  ?>
<?php 
								ini_set("display_errors", "off");
								include_once("Nigeria/scripts/config.php");
								$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=13");
...
<title>ZODML | Board of Trustees</title>
...
<div id="content_holder">
                        ...
                        <a href="http://www.zodml.org/our-team.php">Our Team</a> > Board of Trustees
                        </div>

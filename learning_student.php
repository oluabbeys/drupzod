...
<div id="content_holder">
                        ...
                        <div id="learning_content_holder">
                        	<div id="learning_content_title_hold">
                                <div id="learning_content_box"><div style="padding:15px; font-weight:800; font-size:20px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;">Books</div></div>
                                <div id="learning_content_box"><div style="padding:15px; font-weight:800; font-size:20px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;">Homework Help Sites</div></div>
                                <div id="learning_content_box"><div style="padding:15px; font-weight:800; font-size:20px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;">Cool Sites</div></div>
                                <div id="learning_content_box"><div style="padding:15px; font-weight:800; font-size:20px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;">Communities</div></div>
                            </div>
    						<!--<p>&nbsp;</p>-->
                            <div id="learning_content_info">
                            
                            	<div id="learning_content_intro">
                                	<table cellspacing="40">
                                    	<tr>
                                        <td><img src="images/CIMG1212-2.jpg" width="250" height="167" /></td>
...
self-learning.</td>
                                ...
                                <div id="learning_content_body">
                                    ...
                                    <td height="291" cellspacing= "40"><ul>
                                      <li>e-books in various subjects</li>  <br />
                                      <li> Links to helpful sites </li>  <br />
                                      <li>Free access to e-books in various subjects                                      </li>  <br />
                                      <li>Communities to interact with peers in other schools </li>  <br />
                                    </ul>
                                      </p></tr>
                                    </table>
                                  ...
                                  <div id="learning_body_boxes">
                                    ...
                                    <tr>
                                    <td height="291" cellspacing= "40"><ul>
                                      <li>All resources in this section are absolutely free
                                      </li>
                                      <br />
                                      <li>You can finally find material customized to suit your learning 					                                      needs</li>  <br />
                                      <li>Access resources to help you with your homework and learning                                      </li>  <br />
                                      <li>You can use these resources anytime, anywhere and at your own                                       pace. </li>  <br />
                                    </ul>
                                      </p></tr>
                                    </table>
                                    </div>

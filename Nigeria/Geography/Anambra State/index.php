<?php 
   header( 'Location: http://zodml.org/discover-nigeria/states/anambra-state' ) ;  
?>
<?php
 error_reporting(0);
//ini_set("display_errors", "off");
include_once("../../scripts/config.php");
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=88");
...
$sql4 = mysql_query("SELECT * FROM articles WHERE id =139");
...
<title>ZODML | Discover Nigeria | Facts about Nigeria | Anambra State (Light of the Nation)</title>

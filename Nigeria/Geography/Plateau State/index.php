<?php 
   header( 'Location: http://zodml.org/discover-nigeria/states/plateau-state' ) ;  
?>
<?php
 error_reporting(0);
//ini_set("display_errors", "off");
include_once("../../scripts/config.php");
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=116");
...
$sql4 = mysql_query("SELECT * FROM articles WHERE id =73");
...
<title>ZODML | Discover Nigeria | Facts about Nigeria | Plateau State (Home of Peace and Tourism)</title>

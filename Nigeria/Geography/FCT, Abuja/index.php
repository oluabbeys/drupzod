<?php 
   header( 'Location: http://zodml.org/discover-nigeria/states/fct-abuja' ) ;  
?>
<?php
 error_reporting(0);
//ini_set("display_errors", "off");
include_once("../../scripts/config.php");
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=99");
...
$sql4 = mysql_query("SELECT * FROM articles WHERE id =82");
...
<title>ZODML | Discover Nigeria | Facts about Nigeria | Federal Capital Territory, Abuja (Center Of Unity)</title>

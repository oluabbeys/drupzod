<?php 
   header( 'Location: http://zodml.org/discover-nigeria/states/cross-river-state' ) ;  
?>
<?php
 error_reporting(0);
//ini_set("display_errors", "off");
include_once("../../scripts/config.php");
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=93");
...
$sql4 = mysql_query("SELECT * FROM articles WHERE id =150");
...
<title>ZODML | Discover Nigeria | Facts about Nigeria | Cross River State (The People's Paradise)</title>

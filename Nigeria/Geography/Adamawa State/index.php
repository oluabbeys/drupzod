...
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=86");
...
$sql4 = mysql_query("SELECT * FROM articles WHERE id =133");
...
<title>ZODML | Discover Nigeria | Facts about Nigeria | Adamawa State (Land of Beauty)</title>

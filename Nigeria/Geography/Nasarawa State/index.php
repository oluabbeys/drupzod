<?php 
   header( 'Location: http://zodml.org/discover-nigeria/states/nasarawa-state' ) ;  
?>
<?php
 error_reporting(0);
//ini_set("display_errors", "off");
include_once("../../scripts/config.php");
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=110");
...
$sql4 = mysql_query("SELECT * FROM articles WHERE id =110");
...
<title>ZODML | Discover Nigeria | Facts about Nigeria | Nasarawa State (Home of Solid Minerals)</title>
...
<script type="text/javascript">
function open_win(){
	window.open("../../email_a_friend.php?code=<?php echo $id; ?>","_blank","menubar=no, scrollbar=no, resizable=no, width=400, height=450");
}
</script>
<!--Facebook API-->
<div id="fb-root"></div>

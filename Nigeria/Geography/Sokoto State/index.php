<?php 
   header( 'Location: http://zodml.org/discover-nigeria/states/sokoto-state' ) ;  
?>
<?php
 error_reporting(0);
//ini_set("display_errors", "off");
include_once("../../scripts/config.php");
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=118");
...
$sql4 = mysql_query("SELECT * FROM articles WHERE id =85");
...
<title>ZODML | Discover Nigeria | Facts about Nigeria | Sokoto State (Seat of the Caliphate)</title>

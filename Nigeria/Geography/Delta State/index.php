<?php 
   header( 'Location: http://zodml.org/discover-nigeria/states/delta-state' ) ;  
?>
<?php
 error_reporting(0);
//ini_set("display_errors", "off");
include_once("../../scripts/config.php");
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=94");
...
$sql4 = mysql_query("SELECT * FROM articles WHERE id =153");
...
<title>ZODML | Discover Nigeria | Facts about Nigeria | Delta State (The Big Heart)</title>

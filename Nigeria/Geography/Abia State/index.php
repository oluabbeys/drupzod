...
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=85");
...
$sql4 = mysql_query("SELECT * FROM articles WHERE id =140");
...
<title>ZODML | Discover Nigeria | Facts about Nigeria | Abia State (God's own State)</title>

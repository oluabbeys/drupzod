<?php  
  header('Location: http://zodml.org/discover-nigeria/states/akwa-ibom-state' ); 
?>
<?php
 error_reporting(0);
//ini_set("display_errors", "off");
include_once("../../scripts/config.php");
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=87");
...
$sql4 = mysql_query("SELECT * FROM articles WHERE id =141");
...
<title>ZODML | Discover Nigeria | Facts about Nigeria | Akwa Ibom State (Land of Promise)</title>
...
<div id="content_holder_contents">
                ...
                <?php //include("browse2.php"); ?>
                	...
                	<div id="s_sample2">
                    	<!--Article title-->
                    	<div style="width:525px; height:40px; float:left; margin-right:10px; font-size:13px;"><a href="http://www.zodml.org">Home</a> > <a href="http://www.zodml.org/Nigeria">Nigeria</a> > <a href="http://www.zodml.org/Nigeria/Geography">Geography</a> > <?php echo $title; ?></div> 

<?php 
   header( 'Location: http://zodml.org/discover-nigeria/states/kano-state' ) ;  
?>
<?php
 error_reporting(0);
//ini_set("display_errors", "off");
include_once("../../scripts/config.php");
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=104");
...
$sql4 = mysql_query("SELECT * FROM articles WHERE id =95");
...
<title>ZODML | Discover Nigeria | Facts about Nigeria | Kano State (Centre of Commerce)</title>

<?php 
   header( 'Location: http://zodml.org/discover-nigeria/states/taraba-state' ) ;  
?>
<?php
 error_reporting(0);
//ini_set("display_errors", "off");
include_once("../../scripts/config.php");
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=119");
...
$sql4 = mysql_query("SELECT * FROM articles WHERE id =107");
...
<title>ZODML | Discover Nigeria | Facts about Nigeria | Taraba State (Nature's Gift to the Nation)</title>

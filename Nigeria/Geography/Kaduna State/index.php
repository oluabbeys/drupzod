<?php 
   header( 'Location: http://zodml.org/discover-nigeria/states/kaduna-state' ) ;  
?>
<?php
 error_reporting(0);
//ini_set("display_errors", "off");
include_once("../../scripts/config.php");
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=103");
...
$sql4 = mysql_query("SELECT * FROM articles WHERE id =158");
...
<title>ZODML | Discover Nigeria | Facts about Nigeria | Kaduna State (Centre of Learning)</title>

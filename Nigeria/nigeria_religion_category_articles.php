...
$do = mysql_query("SELECT * FROM articles where category ='Religion' ORDER BY id ASC");
...
$sql = "SELECT * FROM articles where category ='Religion' ORDER BY id ASC";
$rsd = mysql_query($sql);
...
<title>Zaccheus Onumba Dibiaezue Memorial Libraries|e-library in Nigeria|Library services|Discover Nigeria|Religion</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#discover_nig_content_category_article").load("religion_data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#discover_nig_content_category_article").load("religion_data.php?page=" + pageNum, Hide_Load());
	});

...
<div id="content_holder_contents">
                ...
                <!--SAMPLE DIV-->
                	<div id="s_sample2">
                    	<!--Article title-->
                    	<div style="width:395px; height:40px; float:left; margin-right:10px;"><?php echo $row4['title']; ?></div> 
                        		...
                        		<div style="width:160px; height:40px; float:left; margin:10px 0px 20px 0px;">
                                    ...
                                    <div id="megamenu1" class="megamenu">
                                        ...
                                        <h3><a href="nigeria_people_category_articles.php">People Home</a></h3>
                                            <ul>
                                            <li><a href="nigeria_geography_category_articles.php">Geography</a></li>

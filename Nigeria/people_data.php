...
$sql = mysql_query("SELECT * FROM articles WHERE category ='People' ORDER BY title ASC limit $start,$per_page");
//$rsd = mysql_query($sql);
?>
	...
	<div id="discover_nigeria_category_people_article_hold">
        ...
        <td valign="top">
        <div id="discover_nigeria_category_people_article_topic"><?php echo "<a href=\"nigeria_people_content_articles.php?article_id=".$title."\">$title</a>"; ?></div>
        <div id="discover_nigeria_category_people_article_content"><?php echo myTruncate($intro, 200)." "."<a href=\"nigeria_people_content_articles.php?article_id=".$title."\">Read more</a>"; ?></div>

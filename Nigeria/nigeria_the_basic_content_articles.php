...
if(isset($_GET['article_id'])){
	$article_code = $_GET['article_id'];
				...
				// including the scripts that gives access to the database
					...
					$sql4 = mysql_query("SELECT * FROM articles WHERE id ='$article_code'");
...
<div id="content_holder">
				...
				?>
                    ...
                    <td>
                            <!--facebook API-->
                            	<div class="fb-like" data-href="http://zodml.org/Nigeria/nigeria_the_basic_content_articles.php?article_id=<?php echo $article_code; ?>" data-send="false" data-layout="button_count" data-width="100" data-show-faces="false" data-font="verdana" style="margin:0px 0px 0px 10px;"></div>

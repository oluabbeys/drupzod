...
$do = mysql_query("SELECT * FROM articles where id = 69 ORDER BY id DESC");
...
//			<div id="discover_nigeria_category_people_article_dateposted_author_hold"><div id="discover_nigeria_category_people_article_author"> ' .'Author:'.' '. $author . '</div>
//			<div id="discover_nigeria_category_people_article_date_posted">'.'Dated Posted:'.' '. $date.'</div></div>
//			</div>';
...
<title>Zaccheus Onumba Dibiaezue Memorial Libraries|e-library in Nigeria|Library services|Discover Nigeria|Delta state</title>
...
<script type="text/javascript">
function open_win(){
	window.open("email_a_friend.php?code=<?php echo "$id" ?>","_blank","menubar=no, scrollbar=no, resizable=no, width=400, height=410");
}
</script>
<!--Facebook API-->
<div id="fb-root"></div>
...
<ul id="mega-menu-tut" class="menu">
    ...
    <li><a href="#">Learning</a>
		<ul>
			<li id="menu-item-1"><a href="#">Children</a>
				<ul>
					<li><a href="../children35_home.php">3-5 Years</a></li>
			...
			<li id="menu-item-2"><a href="#">Students</a>
			    <ul>
					...
					<li><a href="../jss_home.php">Junior Secondary</a></li>
					<li><a href="../sss_home.php">Senior Secondary</a></li>
                    <li><a href="../research_guide.php">Tertiary</a></li>
			...
			<li id="menu-item-3"><a href="#">Research</a>
			    <ul>
					...
					<li><a href="../research_guide.php">Research Guides</a></li>
	...
	<li><a href="#">Communities</a>
        ...
        <li><a href="../community.php">DLC</a></li>
        </ul>
    </li>
	</ul>
</div>
...
<div id="content_holder">
                	...
                	<div id="browse_by_select_category">
                		<div style="padding:8px; font-size:12px;">Browse by category</div>
                        	<div style="padding:15px; margin:0px 0px 5px 50px;">
                            	...
                            	<div id="cat_list"><a href="nigeria_geography_category_articles.php">Geography</a></div>
                                <div id="cat_list"><a href="nigeria_history_category_articles.php">History</a></div><!--<div id="cat_list">Technology</div>-->
                   			</div>
                            <div style="padding:15px; margin:0px 0px 5px 50px;">
                            ...
                            <div style="padding:15px; margin:0px 0px 5px 50px;">
                                ...
                                <div id="cat_list"><a href="nigeria_the_diaspora_articles.php">The Diaspora</a></div>
                   			</div>
                ...
                <!--END OF CONTENT LAYER 2-->
                    ...
                    <tr>
                    <td>
                    	<div style="width:800px;">Delta state</div>
                    </td>
                    <td valign="middle" align="right"><div id="email_a_friend" onclick="open_win();" title="Email a friend"></div></td>
                    <td>
                            <!--facebook API-->
                            	<div class="fb-like" data-href="http://zodml.org/Nigeria/delta_state.php" data-send="false" data-layout="button_count" data-width="100" data-show-faces="false" data-font="verdana" style="margin:0px 0px 0px 10px;"></div>
                ...
                <div id="discover_nigeria_full_story_hold">
                    ...
                    <div id="discover_nigeria_full_story_icons">
                    	<!--<table style="margin-left:15px;">
                            ...
                            <td>-->
                            <!--facebook API-->
                            	<!--<div class="fb-like" data-href="http://zodml.org/zodml_new/Nigeria/delta_state.php" data-send="false" data-layout="button_count" data-width="100" data-show-faces="false" data-font="verdana" style="margin:0px 0px 10px 10px;"></div>-->

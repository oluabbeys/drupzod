...
$do = mysql_query("SELECT * FROM articles where category ='The Diaspora' ORDER BY id ASC");
...
$sql = "SELECT * FROM articles where category ='The Diaspora' ORDER BY id ASC";
$rsd = mysql_query($sql);
...
$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=63");
...
<title>ZODML | Discover Nigeria | Facts about Nigeria | The Diaspora</title>
...
<script type="text/javascript">
   ...
   //Default Starting Page Results
	...
	$("#discover_nig_content_category_article").load("diaspora_data.php?page=1", Hide_Load());
	...
	$("#pagination dt").click(function(){
		...
		$("#discover_nig_content_category_article").load("diaspora_data.php?page=" + pageNum, Hide_Load());
	});
...
<div id="content_holder_diaspora">
                ...
                <!--CONTENT LAYER 3-->
                    ...
                    <div style="width:1000px; margin:0px auto; padding:3px;">

<?php  header( 'Location: http://www.zodml.org/about-us/zodml-newsroom/newspaper-clippings' ) ;  ?>
<?php 
								ini_set("display_errors", "off");
								include_once("Nigeria/scripts/config.php");
								$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=11");
...
<title>ZODML | ZODML in the Press</title>
<link href="css/styles.css" type="text/css" rel="stylesheet" media="screen" />
<link href="css/menu_new.css" type="text/css" rel="stylesheet" media="screen" />
<link href="css/press-bottom.css" type="text/css" rel="stylesheet" media="screen"/>
...
<style type="text/css">
#body_hold #content_holder #aboutus_content_holder2 table tr td #aboutus_content_holder3 #aboutus_cathy #oma_press_content_book_display p a {
	font-family: Georgia, Times New Roman, Times, serif;
}
#body_hold #content_holder #aboutus_content_holder2 table tr td #aboutus_content_holder3 #aboutus_cathy #oma_press_content_book_display p {
	font-family: Georgia, Times New Roman, Times, serif;
}
</style>
...
<div id="index_content_holder">
                        ...
                        <!--CONTENT LAYER 1-->
                        <div id="aboutus_content_press">
                        <a href="http://www.zodml.org/our-story.php">Our Story</a> > ZODML in the Press
                        </div>
                        <!--END OF CONTENT LAYER 1-->
                        <!--CONTENT LAYER 2-->
                        <div id="aboutus_content_press2">
                        <table>
                        <tr>

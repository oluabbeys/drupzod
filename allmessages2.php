...
$sql_in= mysql_query("SELECT dlccomments.serialid,dlccomments.comment,dlccomments.posterid,dlccomments.postertype,dlccomments.postername,dlccomments.postertype,dlccomments.commentid, DATE_FORMAT(dlccomments.dateposted, '%d %b %Y   at %r') as thedate from dlccomments where commentid = " . $thepost . " order by dlccomments.serialid desc limit 0,1");

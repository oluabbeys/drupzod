<?php 
								...
								$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=24");
...
<title>ZODML | Support | Donation to ZODML</title>
...
<div id="content_holder">
                        ...
                        Support ZODML > Donate to ZODML</div>
                        <!--END OF CONTENT LAYER 1-->
                        <!--CONTENT LAYER 2-->
                        <div id="aboutus_content_holder2">
                        <table width="1014">
                        <tr><td width="713" valign="top">

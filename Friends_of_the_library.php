<?php  header( 'Location: http://zodml.org/get-involved/become-friend-library' ) ;  ?>
<?php 
								ini_set("display_errors", "off");
								include_once("Nigeria/scripts/config.php");
								$sql2 = mysql_query("SELECT * FROM contentsupdate WHERE id=23");
...
<title>ZODML | Friends of the Library </title>
...
<div id="content_holder">
                       ...
                       <!-- Services >--> Support  ZODML &gt; Friends of the Library</div>
